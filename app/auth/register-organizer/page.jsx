...
export default function RegisterOrganizerPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.college) newErrors.college = "College/Institution name is required"
      ...
      <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-secondary/5 flex items-center justify-center px-4 py-12">
        <Card className="w-full max-w-md">
          <CardHeader className="space-y-2 text-center">
            ...
            <p className="text-muted-foreground">Join EventifyEDU as an event organizer</p>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <p className="text-center text-sm text-muted-foreground">
              Are you an attendee?{" "}
              <Link href="/auth/register-attendee" className="text-primary hover font-medium">
